      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-3xl ml-auto text-right">
          ...
          <div className="space-y-6">
            <div className="section-stagger group rounded-[2px] border border-white/10 bg-white/[0.01] p-6 md:p-7 transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.03] hover:border-gold/30 hover:shadow-[0_0_40px_-10px_rgba(255,215,0,0.15)] relative overflow-hidden">
